  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Eine kurze Geschichte mit Vokabelliste, Beispielen und Grammatik."
        />
      </Head>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Anna steht vor ihrer Wohnungstür und merkt plötzlich – der Schlüssel ist weg! Panik
              breitet sich aus. Sie durchsucht ihre Tasche, ihre Jacke, sogar ihre Schuhe. Nichts.
              Hat sie ihn im Café liegen lassen?
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <strong>merken</strong> – to notice
              </li>
              <li>
                <strong>Panik</strong> – panic
              </li>
              <li>
                <strong>durchsuchen</strong> – to search through
              </li>
              <li>
                <strong>liegen lassen</strong> – to leave behind
              </li>
            </ul>
          </section>
